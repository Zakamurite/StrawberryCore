...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_HONOR_POINTS_TOTAL_CAP,
    ...
    CONFIG_UINT32_CURRENCY_RESET_WEEK_DAY,
    CONFIG_UINT32_CURRENCY_RESET_HOUR,
    CONFIG_UINT32_ARENA_CONQUEST_POINTS_REWARD,
    CONFIG_UINT32_JUSTICE_POINTS_TOTAL_CAP,
    CONFIG_UINT32_ARENA_SEASON_IN_PROGRESS_ID,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_CONQUEST_POINTS_WEEK_CAP,
    CONFIG_FLOAT_RATE_VALOR_POINTS_WEEK_CAP,
