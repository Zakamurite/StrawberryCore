...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADCURRENCIES,      "SELECT currency, count, thisweek, thisseason FROM character_currency WHERE guid = %u", m_guid.GetCounter());
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADCPWEEKCAP,       "SELECT source, maxWeekRating, weekCap FROM character_cp_weekcap WHERE guid = %u", m_guid.GetCounter());
