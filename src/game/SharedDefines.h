...
enum TradeStatus
{
    TRADE_STATUS_CLOSE_WINDOW               = 0,    // ???
    TRADE_STATUS_TRADE_CANCELED_NO_REPORT   = 1,
    TRADE_STATUS_NOT_ON_TAPLIST             = 2,    // 100 % You may only trade bound items to players that were originally eligible to loot them
    TRADE_STATUS_YOU_LOGOUT                 = 3,
    TRADE_STATUS_IGNORE_YOU                 = 4,
    TRADE_STATUS_TARGET_DEAD                = 5,
    TRADE_STATUS_TRADE_ACCEPT               = 6,    // ??? or 22
